        ...
        >
            ...
            >
                ...
                <div className='w-full md:w-1/2 h-full flex items-center justify-center relative mt-4 md:mt-0'>
                    <textarea
                        ...
                        className={cn(
                            ...
                            { ' border-2 border-t-primary dark:border-t-gray border-x-primary dark:border-x-gray rounded bg-gray dark:bg-primary p-4': isTablet },
                        )}
                    />
                    <label
                        htmlFor={id}
                ...
                <div className='w-full flex md:hidden flex-col gap-y-2 items-center justify-center'>
                    <button
                        className='w-full p-2 rounded bg-primary dark:bg-gray text-white dark:text-primary font-bold text-lg'
                    >Gönder
                    </button>
                    <button
                        className='w-full p-2 rounded text-primary font-bold text-lg'
                    >Taslağı Kaydet
                    </button>
                </div>
            </form>
            <ul className='flex flex-col gap-y-2 md:flex-row md:gap-x-2 items-center justify-center'>
                <li className='text-lg font-bold italic px-2 rounded-sm cursor-pointer hover:bg-primary hover:text-white'>Instagram</li>
                <li className='text-lg font-bold italic px-2 rounded-sm cursor-pointer hover:bg-primary hover:text-white'>Facebook</li>
                <li className='text-lg font-bold italic px-2 rounded-sm cursor-pointer hover:bg-primary hover:text-white'>Unsplash</li>
            </ul>
        </div>
    )
}

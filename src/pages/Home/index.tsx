            ...
            {data.map(({ id, baslik, aciklama }) => (
                <React.Fragment key={id}>
                    ...
                    <div className='flex flex-col gap-y-8 items-center justify-center z-[102]'>
                        ...
                        <h2 className='text-xl font-bold text-start w-full text-white italic'>
                            {aciklama}
                        </h2>
                        <div className='flex flex-row w-full gap-x-6'>
                            <Link to='/albums'
                                  className='bg-secondary dark:bg-gray text-white dark:text-primary px-4 py-2 rounded-md hover:scale-110 transition active:scale-95'>Portfolyom</Link>
                            <Link to='/contact'
                        ...
                        <p className='text-sm text-start text-white w-full'>&copy; 2023. <a
                            className='text-white underline'
                            target='_blank'
                            rel='noreferrer'
                            href='https://github.com/yigityalim'>M.Yiğit Yalım</a></p>
                    </div>
                </React.Fragment>
            ))}
        </div>
